...
public class VerificationCodeEditText extends android.support.v7.widget.AppCompatEditText implements TextWatcher {
    ...
    private void initAttrs(AttributeSet attrs) {
        ...
        mFigures = ta.getInteger(R.styleable.VerCodeEditText_figures, 6);
        mVerCodeMargin = (int) ta.getDimension(R.styleable.VerCodeEditText_verCodeMargin, 1);
        ...
        mSelectedBackgroundColor = ta.getColor(R.styleable.VerCodeEditText_selectedBackgroundColor, getColor(android.R.color.transparent));
        ta.recycle();
    ...
    public void showKeyBoard(Context context) {
        ...
        if (imm != null) {
            imm.showSoftInput(this.getRootView(), InputMethodManager.SHOW_FORCED);
        }
    }
    ...
    public interface OnVerificationCodeChangedListener {
         ...
         * 当验证码变化的时候
         */
        void onVerCodeChanged(CharSequence charSequence, int start, int before, int count);
